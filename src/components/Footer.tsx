      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 pb-10 border-b border-white/10">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center text-white/60 hover:text-accent hover:border-accent/40 transition-all"
            >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8">
          ...
          <div className="flex items-center gap-6">
            <Link href="#" className="text-white/45 text-sm hover:text-white/70 transition-colors min-h-[44px] flex items-center">
              Privacy Policy
            </Link>
            <Link href="#" className="text-white/45 text-sm hover:text-white/70 transition-colors min-h-[44px] flex items-center">
              Terms of Use
            ...
            <div className="flex items-center gap-1.5 text-white/40 text-xs">
              <svg className="w-3.5 h-3.5 text-accent/60" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
